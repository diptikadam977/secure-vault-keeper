...
import { ShieldCheck, LogOut, Settings, Menu, X, ArrowLeft, Unlock } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              Upload an encrypted file and decrypt it with your key
            </p>
          </div>
          ...
          <div className="mt-6 p-4 sm:p-6 bg-card rounded-2xl shadow-card border border-border">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
              <li>• Select your encrypted file (.encrypted extension)</li>
              <li>• Enter the 64-character hex key used to encrypt it</li>
              <li>• Your file will be decrypted locally in your browser</li>
              <li>• Download the original file directly</li>
              <li>• If key is wrong, decryption will fail</li>
            </ul>
          </div>
        </div>
      </main>
